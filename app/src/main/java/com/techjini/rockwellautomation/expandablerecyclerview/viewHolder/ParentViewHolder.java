package com.techjini.rockwellautomation.expandablerecyclerview.viewHolder;
...
/**
 * ViewHolder for a {@link ParentListItem}
...
public class ParentViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
  ...
  /**
   * Returns expanded state for the {@link ParentListItem}
   ...
   * {@link ExpandableRecyclerAdapter}.
   *
   * @param parentListItemExpandCollapseListener The {@link ParentListItemExpandCollapseListener}
   * to
   * set on the {@link ParentViewHolder}
   */
